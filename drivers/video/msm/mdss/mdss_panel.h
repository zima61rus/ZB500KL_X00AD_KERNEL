...
//Start:Reqxxx,liuyang3.wt,ADD,20160305,for ESD
#define PANEL_STATUS_REG_MAX_NUM 3
#define PANEL_STATUS_REG_MAX_RET   4
//End:Reqxxx,liuyang3.wt,ADD,20160305,for ESD

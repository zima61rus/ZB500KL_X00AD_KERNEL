...
struct mdss_dsi_ctrl_pdata {
	...
	struct dsi_panel_cmds status_cmds[PANEL_STATUS_REG_MAX_NUM];//MODIFY for esd
	u32 status_cmds_rlen[PANEL_STATUS_REG_MAX_NUM]; //modify for esd
	u32 status_value[PANEL_STATUS_REG_MAX_NUM][PANEL_STATUS_REG_MAX_RET];    //modify for esd
	u32 status_command_num;
	...
	struct dsi_buf status_buf[PANEL_STATUS_REG_MAX_NUM];  //modify for esd
	int status_mode;
	int rx_len;
